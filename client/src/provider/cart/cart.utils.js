...
export const getCartItemsCount = (cartItems) => cartItems.reduce((totalQuantity, cartItem) => (
    totalQuantity + cartItem.quantity
), 0)

export const getCartItemsTotal = (cartItems) => cartItems.reduce((total, cartItem) => (
